    ...
    <!-- table#enroll>(tr>th+td)*10 -->
        <table id="enroll">
            <tr>
                ...
                <td>
                    <input type="text" name="userId" id="userId" value="yoooonbj">
                </td>
            </tr>
            <tr>
                <th>비밀번호<span class="req">*</span></th>
                <td>
                    <input type="password" name="pwd" id="pwd" value="1234qwer!!!">
                </td>
            </tr>
            <tr>
                <th>비밀번호확인</th>
                <td>
                    <input type="password" id="pwdCheck" value="1234qwer!!!">
                </td>
            </tr>
            <tr>
                <th>이름<span class="req">*</span></th>
                <td>
                    <input type="text" name="userName" id="userName" value="윤봉준"> 
                </td>
            </tr>
            <tr>
                <th>주민번호<span class="req">*</span></th>
                <td>
                    <input type="text" name="ssn1" id="ssn1" class="short" value="900909">-
                    <input type="password" name="ssn2" id="ssn2" class="short" value="1234561">
                </td>
            </tr>
            <tr>
                <th>이메일<span class="req">*</span></th>
                <td>
                    <input type="email" name="email" id="email" value="ybjooooon@naver.com">
                </td>
            </tr>
            <tr>
            ...
            <!-- (input:checkbox#hobby$[name=hobby]+label[for=hobby$])*5 -->
                    ...
                    <input type="checkbox" name="hobby" id="hobby2" value="development" checked>
                    ...
                    <input type="checkbox" name="hobby" id="hobby5" value="movie" checked>
